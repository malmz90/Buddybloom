 ...
 * Use the [StartPagePlantFragment.newInstance] factory method to
...
class StartPagePlantFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return binding.root
       // return inflater.inflate(R.layout.fragment_start_page_plant, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment StartPagePlantFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            StartPagePlantFragment().apply {
